...
def get_interactions():
    interactions = [
        ...
        ("가슴너비", "Chest Breadth", ["Axilla, 좌", "Axilla, 우"], "width", "t"),
        ("허리너비", "Waist Breadth", ["Lateral Waist, 좌", "Lateral Waist, 우"], "width", "t"),
        ("엉덩이너비", "Hip Width", ["Buttock Protrusion level, 좌", "Buttock Protrusion level, 우"], "width", "t"),
        ("발목너비", "Ankle Width", ["Inner Ankle, 우", "Outer Ankle, 우"], "width", "t"),
        ...
        ("목둘레", "Neck Circumference", ["Inferior Thyroid", "Inferior Thyroid"], "circ-h", "t"),
        ("목밑뒤길이", "Back Neck Base Length", ["Lateral Neck, 좌", "Lateral Neck, 우"], "length-h", "t"),
        ("목밑둘레", "Neck Base Circumference", ["Lateral Neck, 좌", "Lateral Neck, 좌"], "circ-h", "t"),
        ...
        ("가슴둘레", "Chest Circumference", ["Anterior Axillary Fold, 우"], "circ-h", "t"),
        ("젖가슴둘레", "Bust Circumference", ["Nipple, 우", "Nipple, 우"], "circ-h", "t"),
        ("젖가슴아래둘레", "Underbust Circumference", ["Inferior Breast level, 우"], "circ-h", "t"),
